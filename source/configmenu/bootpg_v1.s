...
.ELSE
           .ORG $A200  ; use other address for debugging to keep the original boot loader in memory
.ENDIF
START:     JMP boot
...
;  0- 7: $0400, $0480, $0500, $0580, $0600, $0680, $0700, $0780
;  8-15: $0428, $04A8, $0528, $05A8, $0628, $06A8, $0728, $07A8
; 16-23: $0450, $04D0, $0550, $05D0, $0650, $06D0, $0750, $07D0
TITLE_LINE  = $0400
FOOTER_LINE = $07D0
...
APPLE4EVR: .BYTE "APPLE III FOREVER!  V"
           .BYTE '0'+VER_MAJOR
           .BYTE "."
           .BYTE '0'+VER_MINOR
           .BYTE "."
...
.IFNDEF FILE_DEBUG
          ...
          LDA #$01                       ; start with loading sector1/block1 (=A)
          STA SCRATCH
LOADBLOCKS:
...
LOADOK:
          ...
          INC IBBUFP+1
          INC SCRATCH                    ; next block number
          LDA SCRATCH                    ; load current block number
          CMP #BLOCK_COUNT               ; are we done?
          BNE LOADBLOCKS                 ; no => load remaining blocks
